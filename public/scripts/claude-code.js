...
(function (global) {
  ...
  function systemPrompt(cwd) {
    ...
    return [
      ...
      '- #menubar               top menu bar (menus are built by menubar.js)',
      '- #taskbar               bottom dock',
      '- #btn-wifi              Wi-Fi menu-bar button',
      '- #btn-search            Spotlight menu-bar button',
      '- #taskbar-search        search field row inside the Spotlight panel',
      '- #sf-input              search text input',
      '- #btn-start             Home/Start dock button',
      '- #btn-apps              Apps dock button',
      '- #btn-games             Games dock button',
      '- #btn-theater           Theater dock button',
      '- #btn-chat              Chat dock button',
      '- #btn-files             Files dock button',
      '- #btn-terminal          Terminal dock button',
      '- #btn-lmstudio          LM Studio dock button',
      '- #btn-settings          Settings dock button',
      '- #btn-battery           Battery menu-bar button',
      '- #battery-icon          Battery icon <span>',
      '- #tray-time             Clock/date menu-bar area',
      '- #tray-clock            Clock <span> (--:--)',
      '- #tray-date             Date <span>',
      '- #search-flyout         Spotlight search panel',
      ...
      '  Keys match dock button ids minus the "btn-" prefix: terminal, apps, games, chat, files, settings, start, lmstudio',
      '',
